...
struct DesignSystemCaptureStyleTests {
    ...
    func commentInputStyles() {
        ...
        #expect(AppCommentInput.topPadding == 8)
        #expect(AppCommentInput.bottomPadding == 8)
        #expect(AppCommentInput.containerHeight(isFocused: true, hasImage: false) == 64)
        #expect(AppCommentInput.containerHeight(isFocused: false, hasImage: false) == 64)
        #expect(AppCommentInput.containerHeight(isFocused: true, hasImage: true) == 128)
        #expect(AppCommentInput.containerHeight(isFocused: false, hasImage: true) == 128)
