...
object VoiceSessionInstructions {
    fun build(
        ...
        val header = """
            ...
            "시간이 얼마 남지 않았습니다"라는 시스템 안내를 받으면 새 질문을 멈추고, 지금까지 확인된 내용과
            아직 부족한 항목이 있다면 그 항목은 사용자가 이후 화면에서 직접 채워야 한다는 점을 한두 문장으로
            명확히 안내한 뒤, 지금까지 확보한 정보로 save_farming_record 호출을 시도하세요.
        ...
        val pesticideSection = if (pesticides.isEmpty()) null else buildString {
        ...
        return listOfNotNull(header, pesticideSection, footer).joinToString("\n\n")
    }
}
